...
def game_over(state):
    """
    Fucntion calls wins() function for both players to check if the game has ended
...
def empty_cells(state):
    """
    Fucntion marks empty cells for valid move options
...
def minimax(state, depth, player):
    """
    Fucntion running the AI calculations upon the game dependant on it's depth, current player, and game state.
...
def clean():
    """
    Funtion calls system funtion to refresh the screen
